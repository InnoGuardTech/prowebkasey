...
const expense_categories_service_1 = require("./expense_categories.service");
const expense_categories_controller_1 = require("./expense_categories.controller");
...
exports.ExpenseCategoriesModule = ExpenseCategoriesModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([expense_category_entity_1.ExpenseCategory])],
